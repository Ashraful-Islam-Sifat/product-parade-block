	...
	return (
		<div className="ppb-editor-typography">
			<div className="ppb-editor-typography-header">
				<p className="product-parade-block-sidebar-label-text">
					Typography
				</p>
				<button
			...
			<div
				className={
					isOpen ? 'typography-area open' : 'typography-area'
				}
			>
				{ fontSize && (
					<MyRangeControl
				...
				{ fontFamily && (
					<SelectControl
						...
						onChange={ ( newValue ) =>
							setAttributes( { [ fontFamily ]: newValue } )
						}
					/>
				) }
				...
				{ fontWeight && (
					<SelectControl
						...
						onChange={ ( newValue ) =>
							setAttributes( { [ fontWeight ]: newValue } )
						}
					/>
				) }
			</div>
